...
%
\begin{lstlisting}
https://github.com/ashish-hk/Assignment_3/blob/main/Assignment3.ipynb
\end{lstlisting}
%
Download latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/ashish-hk/Assignment_3/blob/main/main.tex
\end{lstlisting}
%
\section{Problem}
Solve:
\textbf{Problem set: Vector2, Example-5,5}
